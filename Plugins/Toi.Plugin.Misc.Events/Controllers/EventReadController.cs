...
{
    public class EventReadController : BaseNopController
    {
        #region Fields
        ...
        #region Ctors
        public EventReadController(IEventService eventService,
        ...
        public ActionResult Index(EventsPagingFilteringModel command)
        {
            ...
            var events = _eventService.GetAllEvents(pageIndex: command.PageNumber - 1, pageSize: 10);
            model.Events = events.Select(q =>
            {
